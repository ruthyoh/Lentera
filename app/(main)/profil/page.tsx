...
export default function HalamanProfil() {
  // Data placeholder — akan diganti dengan data dari Supabase
  const profil = {
  ...
  const ikonAktivitas: Record<string, React.ReactNode> = {
    unggah: <Upload size={14} style={{ color: 'var(--color-forest-600)' }} />,
    suka: <Heart size={14} style={{ color: 'var(--color-terracotta-500)' }} />,
    unduh: <Download size={14} style={{ color: 'var(--color-forest-600)' }} />,
        ...
        <div className="container-lentera relative z-10">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div
              ...
              style={{ background: 'var(--color-cream-200)', color: 'var(--color-forest-700)' }}
              aria-hidden="true"
            >
              AR
            </div>
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <div className="flex items-center gap-4 justify-center md:justify-start text-xs" style={{ color: 'rgba(245,240,232,0.6)' }}>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card-glass p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  { label: 'Materi Diunggah', angka: profil.statistik.materiDiunggah, ikon: <Upload size={18} />, warna: 'forest' },
                  { label: 'Disukai', angka: profil.statistik.materiDisukai, ikon: <Heart size={18} />, warna: 'terracotta' },
                  { label: 'Total Unduhan', angka: profil.statistik.totalUnduhan, ikon: <Download size={18} />, warna: 'forest' },
                  ...
                  <div
                    ...
                    style={{ background: stat.warna === 'forest' ? 'var(--color-forest-50)' : 'var(--color-terracotta-50)' }}
                  >
                    <div
                      className="w-10 h-10 rounded-lg flex items-center justify-center mx-auto mb-2"
                      style={{
                        background: stat.warna === 'forest' ? 'var(--color-forest-100)' : 'var(--color-terracotta-100)',
                        color: stat.warna === 'forest' ? 'var(--color-forest-700)' : 'var(--color-terracotta-600)',
                      }}
                      aria-hidden="true"
                    >
                      {stat.ikon}
                ...
                {aktivitasTerbaru.map((aktivitas, i) => (
                  ...
                  >
                    <div
                      ...
                      style={{ background: aktivitas.tipe === 'beasiswa' || aktivitas.tipe === 'suka' ? 'var(--color-terracotta-50)' : 'var(--color-forest-50)' }}
                      aria-hidden="true"
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs mt-0.5" style={{ color: 'var(--color-charcoal-400)' }}>
                        {aktivitas.waktu}
                      </p>
                    </div>
                  </div>
                ...
                {[
                  ...
                  <div key={info.label} className="flex items-start gap-3">
                    <div
                      ...
                      style={{ background: 'var(--color-cream-300)', color: 'var(--color-charcoal-500)' }}
                    >
                      {info.ikon}
                    </div>
                    <div>
                      ...
                      <p className="text-sm font-medium" style={{ color: 'var(--color-charcoal-900)' }}>
                        {info.nilai}
                      </p>
                    </div>
                  </div>
            ...
            <div className="card-glass p-6">
              ...
              <div className="space-y-2">
                {[
                  ...
                  >
                    <span style={{ color: 'var(--color-forest-600)' }}>{link.ikon}</span>
                    {link.label}
                  </Link>
                ))}
              </div>
